...
@section('content')
    <div class="card py-3 px-4">
        ...
        <div class="mb-3 row align-items-center">
            ...
            <div class="col-sm-10">
              <input type="text" disabled class="form-control" id="nama" value="{{$siswa->kelas->nomor_kelas}} {{ $siswa->kelas->nama_jurusan }}">
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <ol class="list-group list-group-numbered">
            ...
            <li class="list-group-item d-flex justify-content-between align-items-start" style="margin-bottom: 1px">
                ...
                <form class="ml-auto align-self-center mr-3"  action="/pelanggaran/delete/{{ $p->id }}" method="post">    
                    @csrf
